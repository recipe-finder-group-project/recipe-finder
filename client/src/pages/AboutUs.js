            ...
            <div className="left-right-align">
              ...
              <div>
                <p className="footer-description-text">
                  ...
                  nourishing for your body as it is effortless for your
                  schedule. Our platform revolutionizes the all-too-common
                  query, "What's for dinner?" transforming it into an exciting
                  exploration of wholesome eating. Conceived from a fusion of
                  culinary passion and technological prowess, Healthy is the
                  innovation of a team united by the goal of making healthful
                  eating straightforward and accessible.
                </p>

                <p className="footer-description-text">
                  The seed for Healthy was planted by two friends faced with the
                  challenge of navigating the maze of online recipes to find
                  options that were both wholesome and simple to prepare. With
                  one an epicure with a love for wholesome foods and the other a
                  tech wizard with a knack for streamlining processes, they
                  crafted an app designed to alleviate the struggle. Healthy was
                  born to swiftly curate personalized recipes that align with
                  your dietary preferences, using ingredients already in your
                  pantry.
                </p>
