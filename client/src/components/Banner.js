...
const BannerComponent = () => {
  ...
  return (
    <div className="container-fluid p-0 d-flex" style={{ height: "400px" }}>
          ...
          <Card className="rounded-15" style={{ flexGrow: "1" }}>
            ...
            >
              <div style={{ paddingTop: "12px" }}>
                ...
                <Card.Title className="title-text-ban">Recipe Finder</Card.Title>
              </div>
      ...
      <div className="carousel-container" style={{ width: isMobile ? "100%" : "50%" }}>
        <Carousel fade className="rounded-15 h-100">
          <Carousel.Item>
            <img className="d-block w-100" src={veganimage} alt="Vegan Lunches" />
            <Carousel.Caption>
              <h2 style={{ textAlign: "left" }}>Vegan Creations</h2>
            </Carousel.Caption>
          </Carousel.Item>
          <Carousel.Item>
            <img className="d-block w-100" src={mediimage} alt="Mediterranean Creations" />
            <Carousel.Caption>
              <h2 style={{ textAlign: "left" }}>Mediterranean Marvels</h2>
            </Carousel.Caption>
          </Carousel.Item>
          <Carousel.Item>
            <img className="d-block w-100" src={veggieimage} alt="Vegetarian Tastes" />
            <Carousel.Caption>
